...
function DQ_genrules(d, p, n_s)
    ...
    run(`'/Applications/MATLAB_R2024a.app/bin/maca64/MATLAB' -nodisplay -nosplash -nodesktop -r "addpath(genpath('/Users/jacobgosselin/Documents(local)/GitHub/DQ_FOR_BLP/Grumps.jl/src/integrators/designedquadrature/matlab_code')); [XW,deltamain]=generator($d,$p,$n_s); save('/Users/jacobgosselin/Documents(local)/GitHub/DQ_FOR_BLP/Grumps.jl/src/integrators/designedquadrature/matlab_code/$(d)_$(p)_$(n_s).mat', 'XW'); exit;"`)
...
function DQ_readrules(d, p, n_s)
    ...
    file_path = "/Users/jacobgosselin/Documents(local)/GitHub/DQ_FOR_BLP/Grumps.jl/src/integrators/designedquadrature/matlab_code/$(d)_$(p)_$(n_s).mat"
    # Check if the file exists
    if !isfile(file_path)
        # If the file does not exist, generate it using DQ_rules
        DQ_genrules(d, p, n_s)
    end
    mat = matread("/Users/jacobgosselin/Documents(local)/GitHub/DQ_FOR_BLP/Grumps.jl/src/integrators/designedquadrature/matlab_code/$(d)_$(p)_$(n_s).mat")
