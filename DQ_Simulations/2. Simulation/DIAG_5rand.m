...
save('DIAG_5rand_output.mat','Mfval', 'Hfval', 'Qfval', 'Mtime', 'Htime', 'Qtime', 'Miter', 'Hiter', 'Qiter', 'Hfun', 'Mfun','Qfun','Mmean', 'Hmean', 'Qmean', 'R_set_M', 'R_set_H', 'Q_plan', 'parameter','nrx','Sim')
